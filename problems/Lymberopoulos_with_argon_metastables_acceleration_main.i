#This is an example file based on a low pressure
#CCP discharge that incorporates acceleration by
#averaging densities and acceleration by Shooting Method.
...
[MultiApps]
  ...
  [./Shooting]
    ...
    input_files = 'Lymberopoulos_with_argon_metastables_acceleration_Shooting.i'
  ...
  [./Averaging_Acceleration]
    type = FullSolveMultiApp
    input_files = 'Lymberopoulos_with_argon_metastables_acceleration_averaging.i'
    execute_on = 'TIMESTEP_END'
    enable = false
  [../]
[]
