...
[Variables]
  ...
  [N]
    family = SCALAR
    order = FIRST
    initial_condition = 4583541313794.3
  []
  ...
  [N2]
    family = SCALAR
    order = FIRST
    initial_condition = 19299991664183000000
    #scaling = 1e-9
  []
  ...
  [e]
    family = SCALAR
    order = FIRST
    initial_condition = 100000002345097
  []
  ...
  [N2O]
    family = SCALAR
    order = FIRST
    initial_condition = 186239152068570
  []
  ...
  [N2O3]
    family = SCALAR
    order = FIRST
    initial_condition = 482024320.89568
  []

  [N2O4]
    family = SCALAR
    order = FIRST
    initial_condition = 2995035.5345115
  []

  [N2O5]
    family = SCALAR
    order = FIRST
    initial_condition = 550595348665.12
  []
  ...
  [NO]
    family = SCALAR
    order = FIRST
    initial_condition = 4315364670383.2
  []
    
  [NO+]
    family = SCALAR
    order = FIRST
    initial_condition = 208693326.20518
  []
  ...
  [NO2]
    family = SCALAR
    order = FIRST
    initial_condition = 13281719079230
  []
  
  [NO2+]
    family = SCALAR
    order = FIRST
    initial_condition = 11067435.60185
  []
  
  [NO2-]
    family = SCALAR
    order = FIRST
    initial_condition = 1201435.9897262
  []
  
  [NO3]
    family = SCALAR
    order = FIRST
    initial_condition = 910111341726.84
  []
  
  [NO3-]
    family = SCALAR
    order = FIRST
    initial_condition = 204628205.06308
  []

  [O]
    family = SCALAR
    order = FIRST
    initial_condition = 90398259049071
  []
  ...
  [O2]
    family = SCALAR
    order = FIRST
    initial_condition = 5291998702673300000
  []
  ...
  [O2-]
    family = SCALAR
    order = FIRST
    initial_condition = 8660966.6158896
  []

  [O2a]
    family = SCALAR
    order = FIRST
    initial_condition = 2675056659474200
  []

  [O3]
    family = SCALAR
    order = FIRST
    initial_condition = 136786493156740000
  []
  [O3-]
    family = SCALAR
    order = FIRST
    initial_condition = 2920718.8611812
  []
