...
[GlobalReactions]
  [Air]
    ...
    reactions = '
                  ...
                  e + N2  -> N2D + N + e             : EEDF (C23_N2_Excitation_13.00_eV)
                  e + N2 -> e + N2A3                 : {3.34e-10 * (Te^(-0.06)) * exp(-8.5/Te)}
                  e + N2 -> e + e + N2+              : EEDF (C50_N2A3_Ionization_10.79_eV)
                  e + O2  -> O + O + e               : EEDF (C36_O2_Excitation_6.00_eV)
                  e + O2  -> O1D + O + e             : EEDF (C37_O2_Excitation_8.40_eV)
                  e + O2  -> O2a + e                 : EEDF (C33_O2_Excitation_0.98_eV)
                  e + O3 -> O + O2 + e               : {1.78e-6 * (Te^(-0.614))*exp(-11.5/Te)}
                  e + O  -> O1D + e                  : EEDF (C63_O_Excitation_1.97_eV)
...
#e + O -> O+ + e + e                : EEDF (C65_O_Ionization_13.62_eV)
