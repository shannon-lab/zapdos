...
[GlobalReactions]
  [Air]
    ...
    equation_values = '400 3.141 8.6173e-5'
...
[AuxScalarKernels]
  ...
  [reduced_field_calculation]
    ...
    variable = reduced_field
    use_time = true
    property_file = 'data/reduced_field2.txt'
