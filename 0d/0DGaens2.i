...
[GlobalReactions]
  [Air]
    ...
    e + O4+ -> O2 + O2                 : {1.4e-6 * (300/(0.66*Te/kb))^0.5}
    e + NO3 + M -> NO3- + M            : 1e-30
    ...
    O + O2a -> O2 + O                  : 7e-16
    N2+ + N2A3 -> N3+ + N              : 1e-10
    e + N2D -> N + e                   : {5.06e-9 * exp(-10.8/(Te^(3.95)))}e + NO + M -> NO- + M              : 1e-30
    e + NO2 -> O- + NO                 : 1e-11
    e + O + N2 -> O- + N2              : 1e-31
...
#e + N2O + N2 -> N2O- + N2          : {(4.27 * ((0.66*Te/kb)+0.412)^2 - 1.268) * 1e-31}
#O- + N2O -> N2O- + O               : 2e-12
...
#e + O1D -> e + O                   : EEDF (C63_O_Excitation_1.97_eV)
#e + NO + M -> NO- + M              : 1e-30
#e + NO2 -> O- + NO                 : 1e-11
#O2- + N2 -> O2 + N2 + e            : {1.9e-12 * (Tg/300)^0.5 * exp(-4990/Tg)}
#O2- + O2 -> O2 + O2 + e            : {2.7e-10 * (Tg/300)^0.5 * exp(-5590/Tg)}
...
#O + O2a -> O2 + O                  : 7e-16
#N2+ + N2A3 -> N3+ + N              : 1e-10
#N2 + N4+ -> N2+ + N2 + N2          : {exp(-14.6 + 0.0036*(Tg-300))}
...
[Functions]
  [reduced_field_time2]
    ...
    symbol_names = 'M'
    symbol_values = 'M'
    expression = '22000 * abs(sin(800*3.1415926*t + 800*3.1415926*0.00015625))/(0.2*M*1e-17)'
  []
...
[Controls]
  [c1]
    type = TimePeriod
    enable_objects = 'AuxScalarKernels::field_calc1'
    disable_objects = 'AuxScalarKernels::field_calc2'
    start_time = '0.00734375'
    end_time = '0.01734375'
  []
[]
