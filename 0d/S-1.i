...
[Functions]
  [reduced_field_time2]
    ...
    symbol_names = 'M'
    symbol_values = 'M'
    expression = '10000 * abs(sin(1e9*3.1415926*t))/(0.2*M*1e-17)'
  []
...
[Controls]
  [a2]
    type = TimePeriod
    enable_objects = 'AuxScalarKernels::pon TimeStepper::cst1 Output::out1'
    disable_objects = 'AuxScalarKernels::poff TimeStepper::cst2 Output::out2'
    start_time = '0.00125'
    end_time = '0.001250001'
  []
  [c1]
    type = TimePeriod
    enable_objects = 'AuxScalarKernels::poff TimeStepper::cst2 Output::out2'
    disable_objects = 'AuxScalarKernels::pon TimeStepper::cst1 Output::out1'
    start_time = '1e-9'
    end_time = '0.00125'
  []
[]
