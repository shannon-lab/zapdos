...
[Variables]
  ...
  [N2O3]
    family = SCALAR
    order = FIRST
    initial_condition = 1539426.824
  []

  [N2O4]
    family = SCALAR
    order = FIRST
    initial_condition = 70011662.15
  []

  [N2O5]
    family = SCALAR
    order = FIRST
    initial_condition = 7.01e14
    #scaling = 1e-9
  []
[]
...
[GlobalReactions]
  [Air]
    ...
    e + N2O + N2 -> N2O- + N2          : {(4.72*(Te + 0.412)^2 - 1.268)*1e-31}
    N2O+ + NO -> NO+ + N2O             : 2.3e-10
'
  []
[]
