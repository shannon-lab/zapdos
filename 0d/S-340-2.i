...
[Variables]
  ...
  [N2]
    family = SCALAR
    order = FIRST
    initial_condition = 19299980359182000000
    #scaling = 1e-9
  []
  ...
  [e]
    family = SCALAR
    order = FIRST
    initial_condition = 100000002045487
  []
  ...
  [N2O]
    family = SCALAR
    order = FIRST
    initial_condition = 98660149726900
  []
  ...
  [N2O3]
    family = SCALAR
    order = FIRST
    initial_condition = 427191006.09433
  []

  [N2O4]
    family = SCALAR
    order = FIRST
    initial_condition = 1633885.8859592
  []

  [N2O5]
    family = SCALAR
    order = FIRST
    initial_condition = 185237851841.62
  []
  ...
  [NO]
    family = SCALAR
    order = FIRST
    initial_condition = 5178517594289.9
  []
    
  [NO+]
    family = SCALAR
    order = FIRST
    initial_condition = 209380518.81229
  []
  ...
  [NO2]
    family = SCALAR
    order = FIRST
    initial_condition = 9824860436186.5
  []
  
  [NO2+]
    family = SCALAR
    order = FIRST
    initial_condition = 3769443.4684822
  []
  
  [NO2-]
    family = SCALAR
    order = FIRST
    initial_condition = 1190087.3016992
  []
  
  [NO3]
    family = SCALAR
    order = FIRST
    initial_condition = 573042641340.67
  []
  
  [NO3-]
    family = SCALAR
    order = FIRST
    initial_condition = 198305630.08869
  []

  [O]
    family = SCALAR
    order = FIRST
    initial_condition = 64225405072690
  []
  ...
  [O2]
    family = SCALAR
    order = FIRST
    initial_condition = 5384957265119800000
  []
  ...
  [O2-]
    family = SCALAR
    order = FIRST
    initial_condition = 9641178.5916216
  []

  [O2a]
    family = SCALAR
    order = FIRST
    initial_condition = 3493770986721500
  []

  [O3]
    family = SCALAR
    order = FIRST
    initial_condition = 74309188849618000
  []
  [O3-]
    family = SCALAR
    order = FIRST
    initial_condition = 1965372.8723749
  []
