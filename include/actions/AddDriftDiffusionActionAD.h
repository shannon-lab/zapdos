...
class AddDriftDiffusionActionAD;

template <>
InputParameters validParams<AddDriftDiffusionActionAD>();

class AddDriftDiffusionActionAD : public Action
{
public:
  AddDriftDiffusionActionAD(InputParameters params);
