...
registerMooseAction("ZapdosApp", AddLotsOfVariables, "add_variable");
registerMooseAction("ZapdosApp", AddLotsOfVariables, "add_kernel");
registerMooseAction("ZapdosApp", AddLotsOfVariables, "add_bc");
