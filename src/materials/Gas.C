...
registerMooseObject("ZapdosApp", Gas);
...
Gas::Gas(const InputParameters & parameters)
  : Material(parameters),
    ...
    _mumean_en(declareProperty<Real>("mumean_en1")),
    _d_mumean_en_d_actual_mean_en(declareProperty<Real>("d_mumean_en_d_actual_mean_en")),
    _diffmean_en(declareProperty<Real>("diffmean_en1")),
