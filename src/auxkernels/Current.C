...
{
  Real r = _sgn[_qp] * 1.6e-19 * 6.02e23 * (_sgn[_qp] * _mu[_qp] * -_grad_potential[_qp](0) * _r_units * std::exp(_density_log[_qp]) - _diff[_qp]* std::exp(_density_log[_qp]) * _grad_density_log[_qp](0)* _r_units);
