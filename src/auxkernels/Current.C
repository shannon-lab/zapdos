...
{
  Real r = _sgn[_qp] * ZAPDOS_CONSTANTS::e * ZAPDOS_CONSTANTS::N_A *
  ...
  if (_art_diff)
  {
    ...
    r += _sgn[_qp] * ZAPDOS_CONSTANTS::e * ZAPDOS_CONSTANTS::N_A * -delta *
         std::exp(_density_log[_qp]) * _grad_density_log[_qp](_component) * _r_units;
  }
