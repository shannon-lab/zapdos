...
#include "ADComsolSecondaryElectronEnergyBC.h"

// MOOSE includes
#include "MooseVariable.h"

registerADMooseObject("ZapdosApp", ADComsolSecondaryElectronEnergyBC);

defineADLegacyParams(ADComsolSecondaryElectronEnergyBC);

InputParameters
ADComsolSecondaryElectronEnergyBC::validParams()
{
...
ADComsolSecondaryElectronEnergyBC::ADComsolSecondaryElectronEnergyBC(
...
ADReal
ADComsolSecondaryElectronEnergyBC::computeQpResidual()
{
  ...
  return -_test[_i][_qp] * _r_units * _se_coeff[_qp] * _se_energy[_qp] * _ion_flux;
}
