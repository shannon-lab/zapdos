...
ElectronsFromIonization::ElectronsFromIonization(const InputParameters & parameters) :
    ...
    _diffem(getParam<bool>("use_material_props") ? getMaterialProperty<Real>("diffem") : _user_diffem),
    _d_diffem_d_actual_mean_en(getParam<bool>("use_material_props") ? getMaterialProperty<Real>("d_diffem_d_actual_mean_en") : _user_d_diffem_d_actual_mean_en),
    _muem(getParam<bool>("use_material_props") ? getMaterialProperty<Real>("muem") : _user_muem),
    _d_muem_d_actual_mean_en(getParam<bool>("use_material_props") ? getMaterialProperty<Real>("d_muem_d_actual_mean_en") : _user_d_muem_d_actual_mean_en),
    _alpha_iz(getParam<bool>("use_material_props") ? getMaterialProperty<Real>("alpha_iz") : _user_alpha_iz),
    _d_iz_d_actual_mean_en(getParam<bool>("use_material_props") ? getMaterialProperty<Real>("d_iz_d_actual_mean_en") : _user_d_iz_d_actual_mean_en),
