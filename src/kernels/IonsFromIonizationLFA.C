...
IonsFromIonizationLFA::IonsFromIonizationLFA(const InputParameters & parameters) :
  Kernel(parameters),
...
IonsFromIonizationLFA::~IonsFromIonizationLFA()
{
}
...
Real
IonsFromIonizationLFA::computeQpJacobian()
{
  return 0.0;
}

Real
IonsFromIonizationLFA::computeQpOffDiagJacobian(unsigned int jvar)
{
