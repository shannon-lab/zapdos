...
ElectronsFromIonizationLFA::~ElectronsFromIonizationLFA()
{
}
...
Real
ElectronsFromIonizationLFA::computeQpJacobian()
{
...
Real
ElectronsFromIonizationLFA::computeQpOffDiagJacobian(unsigned int jvar)
{
