...
NodeAndSidesetBetweenSubdomains::NodeAndSidesetBetweenSubdomains(const InputParameters & parameters)
  : MeshModifier(parameters)
{
}

NodeAndSidesetBetweenSubdomains::~NodeAndSidesetBetweenSubdomains() {}

void
NodeAndSidesetBetweenSubdomains::modify()
{
