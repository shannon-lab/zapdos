...
DGEFieldAdvection::computeQpResidual(Moose::DGResidualType type)
{
  ...
  RealVectorValue _velocity_neighbor = _mu_neighbor[_qp] * _sgn_neighbor[_qp] * -_grad_potential_neighbor[_qp];
  ...
  switch (type)
  {
    ...
    case Moose::Neighbor:
      if ( (_velocity_average * _normals[_qp]) >= 0.0)
        ...
        r += -(_velocity_average * _normals[_qp]) * std::exp(_u_neighbor[_qp]) * _test_neighbor[_i][_qp];
      break;
  }
  return r;
}
...
DGEFieldAdvection::computeQpJacobian(Moose::DGJacobianType type)
{
  ...
  switch (type)
  {
    ...
    case Moose::ElementElement:
      if ( (_velocity_average * _normals[_qp]) >= 0.0)
        jac += (_velocity_average * _normals[_qp]) * std::exp(_u[_qp]) * _phi[_j][_qp] * _test[_i][_qp];
      else
        jac += 0.0;
      break;
    ...
    case Moose::ElementNeighbor:
      if ( (_velocity_average * _normals[_qp]) >= 0.0)
        ...
        jac += (_velocity_average * _normals[_qp]) * std::exp(_u_neighbor[_qp]) * _phi_neighbor[_j][_qp] * _test[_i][_qp];
      break;

    case Moose::NeighborElement:
      if ( (_velocity_average * _normals[_qp]) >= 0.0)
        jac += -(_velocity_average * _normals[_qp]) * std::exp(_u[_qp]) * _phi[_j][_qp] * _test_neighbor[_i][_qp];
      else
        jac += 0.0;
      break;
    ...
    case Moose::NeighborNeighbor:
      if ( (_velocity_average * _normals[_qp]) >= 0.0)
        ...
        jac += -(_velocity_average * _normals[_qp]) * std::exp(_u_neighbor[_qp]) * _phi_neighbor[_j][_qp] * _test_neighbor[_i][_qp];
      break;
  }
  return jac;
}
...
DGEFieldAdvection::computeQpOffDiagJacobian(Moose::DGJacobianType type, unsigned int jvar)
{
  ...
  if (jvar == _potential_id)
  {
    ...
    RealVectorValue _d_velocity_avg_neigh = 0.5 * _mu_neighbor[_qp] * _sgn_neighbor[_qp] * -_grad_phi_neighbor[_j][_qp];
    ...
    switch (type)
    {
      ...
      case Moose::ElementElement:
        if ( (_velocity_average * _normals[_qp]) >= 0.0)
          ...
          jac += (_d_velocity_avg_elem * _normals[_qp]) * std::exp(_u_neighbor[_qp]) * _test[_i][_qp];
        break;
      ...
      case Moose::ElementNeighbor:
        if ( (_velocity_average * _normals[_qp]) >= 0.0)
          ...
          jac += (_d_velocity_avg_neigh * _normals[_qp]) * std::exp(_u_neighbor[_qp]) * _test[_i][_qp];
        break;

      case Moose::NeighborElement:
        if ( (_velocity_average * _normals[_qp]) >= 0.0)
          jac += -(_d_velocity_avg_elem * _normals[_qp]) * std::exp(_u[_qp]) * _test_neighbor[_i][_qp];
        else
          jac += -(_d_velocity_avg_elem * _normals[_qp]) * std::exp(_u_neighbor[_qp]) * _test_neighbor[_i][_qp];
        break;

      case Moose::NeighborNeighbor:
        if ( (_velocity_average * _normals[_qp]) >= 0.0)
          jac += -(_d_velocity_avg_neigh * _normals[_qp]) * std::exp(_u[_qp]) * _test_neighbor[_i][_qp];
        else
          jac += -(_d_velocity_avg_neigh * _normals[_qp]) * std::exp(_u_neighbor[_qp]) * _test_neighbor[_i][_qp];
        break;
    }
  }
  return jac;
